...
class CB(nn.Module):
    def __init__(self, wn, n_feats, act=nn.ReLU(True)):
        ...
        # self.b10 = MWRB(wn, n_feats, act=act)
        # self.b11 = MWRB(wn, n_feats, act=act)
        # self.b12 = MWRB(wn, n_feats, act=act)
        # self.b13 = MWRB(wn, n_feats, act=act)
        # self.b14 = MWRB(wn, n_feats, act=act)
        # self.b15 = MWRB(wn, n_feats, act=act)


        # self.body = nn.ModuleList()
        # for i in range(8):
        #     self.body.append(Unit(wn, n_feats, act=act))
...
class MODEL(nn.Module):
    def __init__(self, args):
        ...
        self.b9 = CB(wn, n_feats, act)
        self.b10 = CB(wn, n_feats, act)
        ...
        self.c9 = FCA(wn, n_feats*10, n_feats)
        self.c10 = FCA(wn, n_feats*11, n_feats)
    ...
    def forward(self, x):
        ...
        b9 = self.b9(o8)
        c9 = torch.cat([o0, o1, o2, o3, o4, o5, o6, o7, o8, b9], dim=1)
        o9 = self.c9(c9)

        b10 = self.b10(o9)
        c10 = torch.cat([o0, o1, o2, o3, o4, o5, o6, o7, o8, o9, b10], dim=1)
        o10 = self.c10(c10)
